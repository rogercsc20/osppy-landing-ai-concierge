      ...
      <Container className="relative">
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
          <div className="lg:col-span-7">
            <h2
              id="real-title"
              className="max-w-[18ch] font-display text-[clamp(2.5rem,5.5vw,4.25rem)] leading-[1.02] tracking-[-0.02em] text-texto"
            >
              {m.real.encabezado}
            </h2>
            ...
            <p className="mt-12 max-w-[52ch] text-lg leading-relaxed text-texto">{m.real.giros}</p>
          </div>
