...
export function Problema() {
  ...
  return (
    <section className="relative overflow-hidden bg-bg-alt px-4 py-24 sm:px-6 sm:py-32 lg:py-36">
      {/* faint warm heat low in the scene */}
      <div aria-hidden="true" className="pointer-events-none absolute -bottom-56 left-1/4 h-[28rem] w-[28rem] rounded-full bg-warm/10 blur-3xl" />
