...
export function Precio() {
  ...
  return (
    <section id="precio" className="px-4 py-section sm:px-6">
        ...
        <Reveal className="mx-auto max-w-2xl">
          ...
          >
            <div className="relative flex flex-col bg-text p-8 text-bg lg:p-12">
              ...
              <a
                href="#demo"
                className="mt-8 flex w-full items-center justify-center gap-2 rounded-full bg-accent py-3.5 text-sm font-semibold text-primary-foreground transition-colors hover:bg-accent-text hover:text-bg sm:mx-auto sm:w-auto sm:px-10"
              >
                {t("cta")}
