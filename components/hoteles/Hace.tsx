...
export function Hace() {
  ...
  return (
    <section className="relative overflow-hidden bg-bg px-4 py-24 sm:px-6 sm:py-32 lg:py-36">
      <div className="mx-auto max-w-6xl">
        <div ref={ref} className="grid items-center gap-16 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="order-1 lg:order-2">
            ...
            <AnimatedGroup className="divide-y divide-line border-y border-line">
              {items.map(({ icon: Icon, title, body }) => (
                <div key={title} className="group flex gap-5 py-6">
                  <span className="mt-0.5 flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-xl border border-line bg-white/[0.03] transition-colors group-hover:border-accent-text/40">
